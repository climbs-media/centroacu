...
@Component({
  ...
  templateUrl: './diario-ejercicio-user.page.html',
  styleUrls: ['./diario-ejercicio-user.page.scss'],
})
export class DiarioEjercicioUserPage implements OnInit {
  ...
  onSubmit(value) {
    ...
    this.firebaseService.crearAnadirEjercicio(data)
      .then(
        res => {
          this.router.navigate(['/ejercicios-del-usuario']);
        }
      );
  }
