...
@Component({
  ...
  templateUrl: './detalles-peso-usuario-administrador.page.html',
  styleUrls: ['./detalles-peso-usuario-administrador.page.scss'],
})
export class DetallesPesoUsuarioAdministradorPage implements OnInit {
